                ...
                <table class="table table-hover table-striped mb-0">
                    ...
                    <thead class="table-dark">
                        <tr>
                            ...
                            <th style="width:25%">ชื่ออาหาร (ไทย)</th>
                            <th style="width:20%">หมวดหมู่</th>
                            <th style="width:40%">วัตถุดิบและส่วนผสม</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php if (!empty($food['image'])): ?>
                                            ...
                                            <img src="uploads/<?= htmlspecialchars($food['image']) ?>" width="80" height="80"
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="manage.php?id=<?= $food['id'] ?>" class="btn btn-sm btn-warning">
                                            แก้ไข
                                        </a>

                                        <a href="index.php?delete_id=<?= $food['id'] ?>" class="btn btn-sm btn-danger"
                                            onclick="return confirm('คุณแน่ใจหรือไม่ที่จะลบเมนูนี้? ข้อมูลวัตถุดิบทั้งหมดจะถูกลบไปด้วย');">
